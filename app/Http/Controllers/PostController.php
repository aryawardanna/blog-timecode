...
class PostController extends Controller
{
    ...
    public function restore($id) {
        ...
        return redirect()->back()->with('success', 'Post berhasil Direstore (Silahkan cek di list post)');
    }
    ...
    public function kill($id) {
        ...
        return redirect()->back()->with('success', 'Post berhasil dihapus secara permanent');
    }
}
